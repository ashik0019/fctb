        ...
        <div class="col-md-8">
            <div class="card" id="cardc">
                <div class="card-header">
                    <div class="float-left"><h2>Agent SignUp</h2></div>
                ...
                <div class="card-body">
                    <form method="POST" action="">
                        ...
                        <div class="form-group row">
                            <label for="membership_number" class="col-md-4 col-form-label text-md-right">{{ __('Membership Number') }}</label>

                            <div class="col-md-6">
                                <input id="membership_number" type="number" class="form-control{{ $errors->has('membership_number') ? ' is-invalid' : '' }}" name="membership_number" value="{{ old('membership_number') }}" required autofocus>
                        ...
                        <div class="form-group row">
                            <label for="file" class="col-md-4 col-form-label text-md-right">{{ __('NID') }}</label>
                        ...
                        <div class="form-group row">
                            <label for="file" class="col-md-4 col-form-label text-md-right">{{ __('Professional Certificate') }}</label>
                        ...
                        <div class="form-group row">
                            <label for="file" class="col-md-4 col-form-label text-md-right">{{ __('Your Declaration File') }}</label>
